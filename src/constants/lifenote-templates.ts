    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "cpr_wishes", labelKey: "lifenote.fields.cprWishes", type: "select", options: ["yes", "no", "family_decides"] },
          { key: "ventilator_wishes", labelKey: "lifenote.fields.ventilatorWishes", type: "select", options: ["yes", "no", "family_decides"] },
          { key: "tube_feeding_wishes", labelKey: "lifenote.fields.tubeFeedingWishes", type: "select", options: ["yes", "no", "family_decides"] },
          { key: "care_location", labelKey: "lifenote.fields.careLocation", type: "select", options: ["hospital", "home", "hospice", "family_decides"] },
          { key: "life_support_notes", labelKey: "lifenote.fields.lifeSupportNotes", type: "textarea", placeholderKey: "lifenote.placeholders.lifeSupportNotes" },
        ],
      },
    ],
  },
